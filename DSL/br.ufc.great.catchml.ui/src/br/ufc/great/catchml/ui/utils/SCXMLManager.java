...
public class SCXMLManager{
	private final static String BUNDLE_NAME = "br.ufc.great.catchml.ui";
			...
			try {
				...
				new Thread(new Runnable() {
					...
					public void run() {
						try {
							//String quotes = "\"";
							//String[] command = {"java",  "-jar", quotes + editorPath + quotes, "-i", quotes + filePath + quotes};
							Runtime.getRuntime().exec("java -jar " + editorPath);
						} catch (IOException e) {
