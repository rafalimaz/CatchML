 ...
 * <ul>
 *   <li>{@link br.ufc.great.catchml.catchML.impl.ScopeDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link br.ufc.great.catchml.catchML.impl.ScopeDeclarationImpl#getException <em>Exception</em>}</li>
 *   <li>{@link br.ufc.great.catchml.catchML.impl.ScopeDeclarationImpl#getHandlers <em>Handlers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScopeDeclarationImpl extends DeclarationImpl implements ScopeDeclaration
{
  ...
  {
    return CatchMLPackage.Literals.SCOPE_DECLARATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CatchMLPackage.SCOPE_DECLARATION__NAME, oldName, name));
  }
  ...
  public ExceptionDeclaration getException()
  {
    if (exception != null && exception.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CatchMLPackage.SCOPE_DECLARATION__EXCEPTION, oldException, exception));
      }
    }
    return exception;
  }
  ...
  public void setException(ExceptionDeclaration newException)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CatchMLPackage.SCOPE_DECLARATION__EXCEPTION, oldException, exception));
  }
  ...
  public EList<HandlerDeclaration> getHandlers()
  {
    if (handlers == null)
    {
      handlers = new EObjectContainmentEList<HandlerDeclaration>(HandlerDeclaration.class, this, CatchMLPackage.SCOPE_DECLARATION__HANDLERS);
    }
    return handlers;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CatchMLPackage.SCOPE_DECLARATION__HANDLERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CatchMLPackage.SCOPE_DECLARATION__NAME:
        return getName();
      case CatchMLPackage.SCOPE_DECLARATION__EXCEPTION:
