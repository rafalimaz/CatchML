 ...
 * <ul>
 *   <li>{@link br.ufc.great.catchml.catchML.impl.DomainmodelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DomainmodelImpl extends MinimalEObjectImpl.Container implements Domainmodel
{
  ...
  {
    return CatchMLPackage.Literals.DOMAINMODEL;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, CatchMLPackage.DOMAINMODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CatchMLPackage.DOMAINMODEL__ELEMENTS:
