...
public class CAEHModel {
	...
	protected Set<ContextProposition> propositions;

	protected Set<SemanticConstraint> semanticConstraints;

	protected Set<TransitionConstraint> transitionConstraints;

	protected ExceptionResolutionStrategy resolutionStrategy;

	protected Set<HandlingScope> handlingScopes;
