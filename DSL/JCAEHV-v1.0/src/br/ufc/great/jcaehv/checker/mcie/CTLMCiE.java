...
public class CTLMCiE {

	public Set<Property> check(KripkeModel kripkeModel, Set<Property> properties) {
	...
	public String convert(KripkeModel kripkeModel) {
		StringBuffer buffer = new StringBuffer();
		buffer.append("(");
	...
	public String convertTransitions(KripkeModel kripkeModel) {
		StringBuffer buffer = new StringBuffer();
	...
	private String convertNextStateTransitions(ContextState state, KripkeModel kripkeModel) {
		StringBuffer buffer = new StringBuffer();
