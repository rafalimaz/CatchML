...
public class JCAEHVReport {
	...
	public JCAEHVReport(String path) {
		this.path = path;
	}

	//TODO: Added new method generateReport
	public StringBuffer generateReport(long time, KripkeModel kripke, Set<Property> properties) {
	...
	public void report(long time, KripkeModel kripke, Set<Property> properties) {
		try {
